...
export const testimonials: Localized<Testimonial[]> = {
  ar: [
    ...
    },
    {
      ...
      verified: true,
      badgeLabel: 'عميل موثّق',
      text: 'قبل ما اتعامل مع حنينه، جرّبت نجّارين غيرن، بس كنت دايماً حاسّ إنو عم ينفرض عليّي ستايل معيّن بدل ما حدا يسمع شو بدي مع حنينه كان الفرق كبير، سمعونا وفهموا رؤيتنا، واشتغلوا معنا تفصيل بتفصيل لنوصل للنتيجة اللي كنا نحلم فيها بيتي طلع أحلى بكتير من ما كنت متخيّل',
    },
    {
      id: 'testimonial-6',
      name: 'خالد منصور',
      verified: true,
      badgeLabel: 'عميل موثّق',
      text: 'كنت مفكّر إنو الفرش بهالمستوى من الفخامة والتصميم رح يكون سعره عالي كتير، خصوصاً بعد تجارب سابقة مع غاليريات دفعت عندها مبالغ كبيرة. بس مع حنينه انبهرت. صراحة ما كنت متخيّل إنو فيني احصل على هالنوع من الفخامة والحرفية بسعر بهالقيمة.',
    },
    {
      id: 'testimonial-7',
      name: 'ليال شدياق',
      verified: true,
      badgeLabel: 'عميل موثّق',
      text: 'أكتر شي لفتني بتجربتي مع حنينه هو الاحترافية والاهتمام بكل تفصيل صغير. حسّيت إنو في حدا فعلاً مهتم يطلع البيت بأجمل صورة، مش بس ينجز الطلب. من أول فكرة لآخر لمسة، كان في ثقة وراحة، والنتيجة فاقت كل توقعاتي.',
    },
  ],
  en: [
    {
