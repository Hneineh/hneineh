  ...
  ar: [
    {
      ...
      numeral: '١',
      title: 'منخطط سوا',
      body: 'منزورك ومنقيس كل تفصيل لنضمن إنو كل قطعة رح تركب بمكانها، كأنها خِلقت إلو',
    ...
    },
    {
      ...
      body: 'منسمعك و منفهم شو عم تتخيل، حتى قبل ما تقدر توصفه منضيف خبرتنا لنخلق أفكار ما بتشبه غيرك',
    ...
    },
    {
      ...
      body: 'من أول خطوة لآخر تفصيل، منلتزم بالدّقة، الإتقان والعناية، لنقدم قطعة تعكس ثقتكم فينا',
